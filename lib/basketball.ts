...
export const BASKETBALL_SUPABASE_CONFIGURED = supabaseUrl !== 'https://placeholder.supabase.co' && supabaseAnonKey !== 'placeholder'

export const BASKETBALL_CHANNEL_NAME = 'basketball-overlay'
export const BASKETBALL_STATE_ID = 'basketball'
export const BASKETBALL_LOCAL_API_PATH = '/api/basketball-state'
export const BASKETBALL_LOCAL_EVENT_KEY = 'basketball-overlay-event'
export const BASKETBALL_LOCAL_CHANNEL_KEY = 'basketball-overlay-channel'
